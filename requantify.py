...
"""
Count reads that support a given position of interest
"""
...
def count_reads(seq_to_pos, cash, bp_dist):
    """
...
def test_run():
    ...
    bam_path = "star_aln/Aligned.sortedByCoord.out.bam"
    bp_dist = 10
    ...
    counts = count_reads(seq_to_pos, cash, bp_dist)
